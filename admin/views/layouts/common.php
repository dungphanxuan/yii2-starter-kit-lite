 ...
 */
use admin\assets_b\BackendAsset;
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <span class="label label-danger">
                                <?php echo \admin\models\SystemLog::find()->count() ?>
                            </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="header"><?php echo Yii::t('backend', 'You have {num} log items', ['num'=>\admin\models\SystemLog::find()->count()]) ?></li>
                                    <li>
                                        <!-- inner menu: contains the actual data -->
                                        <ul class="menu">
                                            <?php foreach(\admin\models\SystemLog::find()->orderBy(['log_time'=>SORT_DESC])->limit(5)->all() as $logEntry): ?>
                                                <li>
