...
namespace admin\modules\widget\controllers;

use common\models\WidgetCarousel;
use Yii;
use common\models\WidgetCarouselItem;
use admin\modules\widget\models\search\WidgetCarouselItemSearch;
...
class WidgetCarouselItemController extends Controller
{
    ...
    public function actionCreate($carousel_id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->save()) {
                Yii::$app->getSession()->setFlash('alert', ['options'=>['class'=>'alert-success'], 'body'=>Yii::t('admin', 'Carousel slide was successfully saved')]);
